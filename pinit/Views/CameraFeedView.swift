    ...
    var body: some View {
        GeometryReader{ geometryProxy in
            ...
            ZStack{
                ...
                if (self.settingsViewModel.onboardingViewModel.checkOnboardingStatus(for: .cameraFeedView) < CameraFeedOnboardingView.ScreenNumber.maxScreenNumber){
                    CameraFeedOnboardingView(parentSize: geometryProxy.size)
                }
            }
