...
struct MainOnboardingView: View {
    ...
    @ViewBuilder
    var body: some View {
        if (self.settingsViewModel.user != nil && self.settingsViewModel.onboardingViewModel.checkOnboardingStatus(for: .authenticatedMainARView) < ScreenNumber.getMaxScreenNumber()){
            VStack{
...
struct MainOnboardingView_Previews: PreviewProvider {
    static var previews: some View {
        MainOnboardingView(screenNumber: .zero, parentSize: .zero)
    }
}
